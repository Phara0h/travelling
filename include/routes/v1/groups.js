...
async function deleteUserByGroup(req, res, router) {
  ...
  var deletedUser = userRoutes.deleteUser(req, res, (needsDomain = false), router);
...
module.exports = function (app, opts, done) {
  ...
  app.get('/group/id/:groupid/type/:grouptype/user/:id', async (req, res) => {
    return await getUserByGroup(req, res, router);
  });
  ...
  app.delete('/group/id/:groupid/type/:grouptype/user/:id', async (req, res) => {
    return await deleteUserByGroup(req, res, router);
  });
